...
class PlanosNaNuvemExcecao implements Exception {
  const PlanosNaNuvemExcecao(this.mensagem);
...
class PlanosNaNuvem {
  ...
  /// [PlanosNaNuvemExcecao] sem conta ou sem rede.
  ...
  /// [PlanosNaNuvemExcecao] se o documento não existe (link errado) ou se
  /// a regra recusar.
